...
import (
	...
	leveldb2 "github.com/plingatech/go-plgchain/blockchain/storage/leveldb"
...
/*
Run: ./go-plgchain regenesis history --triedb "path_to_triedb" --chaindb "path_to_blockchain_db"
*/
