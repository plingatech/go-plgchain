...
import (
	...
	"github.com/plingatech/go-plgchain/command/bridge/common"
	cmdHelper "github.com/plingatech/go-plgchain/command/helper"
...
func createExitTxn(sender ethgo.Address, proof types.Proof) (*ethgo.Transaction, *plgbft.ExitEvent, error) {
	...
	var exitEvent *plgbft.ExitEvent
