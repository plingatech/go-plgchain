...
func setFlags(cmd *cobra.Command) {
	...
	cmd.MarkFlagsMutuallyExclusive(plgbftsecrets.AccountConfigFlag, plgbftsecrets.AccountDirFlag)
}
...
func runCommand(cmd *cobra.Command, _ []string) error {
	...
	secretsManager, err := plgbftsecrets.GetSecretsManager(params.accountDir, params.accountConfig, true)
	if err != nil {
		return err
	}
