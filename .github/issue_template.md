...
## Your environment
- OS and version.
- The version of the Go Plgchain.    
  (*Confirm the version of your Go Plgchain client by running the following command: `go-plgchain version --grpc-address GRPC_ADDRESS`*)
...
- Provide us with the peer list of each of your validators by running the following command: `go-plgchain peers list --grpc-address GRPC_ADDRESS`.
