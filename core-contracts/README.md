...
This repository contains the smart contract suite used in Plinga's POS v3 blockchain.

**_Note: You do not need to clone this repo in order to interact with Plinga POS v3._**
...
**You do not need to clone this repo in order to interact with the Plinga core contracts**
...
Lastly, there are fields for an Etherscan and Plgscan for verifying any deployed contracts on the Ethereum or Plinga mainnets or testnets. (Some additional configuration may be required, only Eth mainnet, Goerli, Plinga POS v1, and Mumbai are configured as of this writing.)
