...
const config: HardhatUserConfig = {
  ...
  etherscan: {
    apiKey: {
      ...
      plgchain: process.env.PLGSCAN_API_KEY !== undefined ? process.env.PLGSCAN_API_KEY : "",
      plgchainTestNet: process.env.PLGSCAN_API_KEY !== undefined ? process.env.PLGSCAN_API_KEY : "",
    },
  },
  mocha: {
    timeout: 100000000,
