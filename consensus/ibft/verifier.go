...
import (
	...
	protoIBFT "github.com/plingatech/plg-ibft/messages/proto"
)

// Verifier impl for plg-ibft
...
// calculateProposalHash is new hash calculation for proposal in plg-ibft,
