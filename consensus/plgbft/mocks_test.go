...
var _ plgbftBackend = (*plgbftBackendMock)(nil)

type plgbftBackendMock struct {
	mock.Mock
}

// GetValidators retrieves validator set for the given block
func (p *plgbftBackendMock) GetValidators(blockNumber uint64, parents []*types.Header) (AccountSet, error) {
	...
	panic("plgbftBackendMock.GetValidators doesn't support such combination of arguments") //nolint:gocritic
}
